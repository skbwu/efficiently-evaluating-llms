...
# what are the settings we will be fitting factor models on the training split of M1 for?
...
for idx in selected_settings.index:
    ...
    # save our U and V
    torch.save(U, f"factor_models/val/{dataset}/U_nfobs={n_full_obs}_p={mcar_obs_prob}.pt")
    torch.save(V, f"factor_models/val/{dataset}/V_nfobs={n_full_obs}_p={mcar_obs_prob}.pt")
