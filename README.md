# Efficiently Evaluating LLM Performance with Five Times Fewer Queries
This repository accompanies the paper "Efficiently Evaluating LLM Performance with Five Times Fewer Queries" submitted to ICML 2026.
